namespace concurrence {
	export namespace mysql {
		...
		export const query: (host: string, query: string, ...params: any[]) => Promise<{[column: string] : any}[]> = function(this: typeof mysql) { 
		...
		export const modify: (host: string, sql: string, ...params: any[]) => Promise<{insertId?: number, affectedRows: number}> = function(this: typeof mysql) {
			return execute.apply(this, Array.prototype.slice.call(arguments)).then((result: ExecuteResult) => {
