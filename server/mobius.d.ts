...
export function createClientPromise<T extends JsonValue | void>(fallback?: () => Promise<T> | T, validator?: (value: any) => boolean): Promise<T>;
export function createServerPromise<T extends JsonValue | void>(ask: () => (Promise<T> | T), includedInPrerender?: boolean): Promise<T>;
export function createClientChannel<T extends Function>(callback: T, validator?: (args: ReadonlyArray<any>) => boolean): Channel;
